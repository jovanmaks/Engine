...
{	
	...
	// Update
	{
		...
		// Timer timer("CameraController::OnUpdate", [&](ProfileResult profileResult) { m_ProfileResults.push_back(profileResult); });
	...
	// Render
	{
		...
		// Timer timer("Renderer Prep", [&](ProfileResult profileResult) { m_ProfileResults.push_back(profileResult); });
...

	{
		...
		// Timer timer("Renderer Draw", [&](ProfileResult profileResult) { m_ProfileResults.push_back(profileResult); });
